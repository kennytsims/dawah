...
export default function Header() {
  return (
    <div className="flex justify-center items-center  h-screen  lg:h-[40rem] sm:h-screen bg-[url(https://kennytsims.github.io/dawah//pictures/light.png)] bg-cover bg-no-repeat bg-center max-w-fullmt-10">
